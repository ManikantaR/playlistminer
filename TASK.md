...
- [~] #5 Executor — manual/API/worker execution slice landed; stale/idempotent/rollback/manual-intervention hardening landed, multi-topic policy still unresolved
